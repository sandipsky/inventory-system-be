...
public class PaymentService {
    ...
    public Page<MasterPaymentDTO> getPaginatedMasterPaymentsList(RequestDTO request) {
        ...
        Specification<MasterPayment> spec = specBuilder.buildSpecification(request.getFilter());
